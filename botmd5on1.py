...
ADMIN_ID = [7833803456, 7564889663]
...
# ==========================================
# 🧠 THUẬT TOÁN AI PREDICTION ENGINE (GIỮ NGUYÊN)
# ==========================================
...
# 🚀 TÍNH NĂNG NÂNG CẤP X2 + THEO DÕI LÃI LỖ
...
def send_start(message):
    ...
    init_user_state(cid)
    if check_auth(cid):
        han = '👑 VĨNH VIỄN - ADMIN' if cid in ADMIN_ID else format_expire_time(authorized_users[cid])
        msg = f"""<pre>╔════════════════════════════════════════════╗
...
# ==========================================
# 🚀 FLASK SERVER - GIỮ BOT SỐNG TRÊN RENDER
# ==========================================
app = Flask(__name__)
